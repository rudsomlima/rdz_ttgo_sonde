var cfgs = [
  ...
  [
    "wifi",
    "Wifi mode (0=off, 1=client, 2=AP, 3=client or AP autoselect on startup)",
  ],
  ...
  [
    ...
    "https://github.com/dl9rdz/rdz_ttgo_sonde/wiki/Display-configuration",
  ],
  ["screenfile", "Screen config (0=automatic; 1-5=predefined; other=custom)"],
  ["display", "Display screens (scan, default, ...)"],
  [
    "dispsaver",
    "Display saver (0=never/1=always/2=ifnorx [+10*n: after n sec.])",
  ],
  ...
  [
    ...
    "https://github.com/dl9rdz/rdz_ttgo_sonde/wiki/Spectrum-configuration",
  ],
  ...
  [
    ...
    "https://github.com/dl9rdz/rdz_ttgo_sonde/wiki/Data-feed-configuration",
  ],
  ["call", "Call"],
  ["passcode", "Passcode"],
  ...
  [
    "tcp.chase",
    "APRS location reporting (0=off, 1=fixed, 2=chase/GPS, 3=auto)",
  ],
  ["tcp.comment", "APRS location comment"],
  [
    "",
    "MQTT data feed configuration",
    "https://github.com/dl9rdz/rdz_ttgo_sonde/wiki/MQTT-configuration",
  ],
  ...
  [
    ...
    "https://github.com/dl9rdz/rdz_ttgo_sonde/wiki/Chasemapper-configuration",
  ],
  ...
  [
    "",
    "SondeHub settings",
    "https://github.com/dl9rdz/rdz_ttgo_sonde/wiki/SondeHub-settings",
  ],
  ["sondehub.active", "SondeHub reporting (0=disabled, 1=active)"],
  [
    "sondehub.chase",
    "SondeHub location reporting (0=off, 1=fixed, 2=chase/GPS, 3=auto)",
  ],
  ...
  [
    "sondehub.email",
    "SondeHub email (optional, only used to contact in case of upload errors)",
  ],
  [
    "",
    "SondeHub frequency import",
    "https://github.com/dl9rdz/rdz_ttgo_sonde/wiki/SondeHub-import",
  ],
  [
    "sondehub.fiactive",
    "SondeHub frequency import active (0=disabled, 1=active)",
  ],
  ...
  [
    ...
    "https://github.com/dl9rdz/rdz_ttgo_sonde/wiki/Hardware-configuration",
  ],
  [
    "disptype",
    "Display type (0=OLED/SSD1306, 1=ILI9225, 2=OLED/SH1106, 3=ILI9341, 4=ILI9342, 5=ST7789)",
  ],
